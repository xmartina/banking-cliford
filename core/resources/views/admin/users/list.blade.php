                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    @isset($kyc)
                                        <a href="{{ route('admin.users.detail.kyc', $user->id) }}" class="icon-btn btn--info ml-1" data-toggle="tooltip" title="" data-original-title="@lang('Veiw KYC Data')">
                                            <i class="las la-notes-medical text--shadow"></i>
                                        </a>
                                    @endisset
                                </td>
                            </tr>
