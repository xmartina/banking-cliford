...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Loan Widgets
        $widget['total_pending_loan']   = UserLoan::pending()->count();
        $widget['total_due_loan']       = UserLoan::due()->count();
        $widget['total_running_loan']   = UserLoan::running()->count();
        $widget['total_paid_loan']      = UserLoan::paid()->count();

        // DPS Widgets
        $widget['total_dps']            = UserDps::count();
        $widget['total_running_dps']    = UserDps::running()->count();
        $widget['total_matured_dps']    = UserDps::matured()->count();
        $widget['total_due_dps']        = UserDps::due()->count();

        // FDR Widgets
        $widget['total_fdr']            = UserFdr::count();
        $widget['total_running_fdr']    = UserFdr::running()->count();
        $widget['total_closed_fdr']     = UserFdr::closed()->count();
        $widget['total_due_fdr']        = UserFdr::due()->count();
