...
@section('panel')
    <div class="row mb-none-30">
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.transfers',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ showAmount($totalTransfers) }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Transfered')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
            ...
            <div class="row mt-3 mb-none-30">

                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--5 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.loans',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                        ...
                        <div class="details">
                            ...
                            <div class="numbers">
                                <span class="amount">{{$totalLoan}}</span>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--19 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.fdr',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="fa fa-wallet"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$totalFdr}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('FDR')</span>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--15 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.dps',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-box"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$totalDps}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('DPS')</span>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--1 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.beneficiaries',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-user-friends"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$totalBeneficiaries}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Beneficiaries')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
